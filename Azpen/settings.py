"""
Django settings for Azpen project.
...
SECRET_KEY = 'django-insecure-nefro8dpr2=bu4fn07%f=g@+0^qez%w!ja$*e32czowaw+@i@b'
...
WSGI_APPLICATION = 'Azpen.wsgi.application'
